...
describe ( 'Color', it => {
  ...
  it ( 'supports HSL', t => {
    ...
    const tests = [
      ...
      ['hsl(0deg, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      ['hsl(180deg, 50%, 50%)', 'hsl(180, 49.8, 50)'],
      ['hsl(360deg, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      ['hsl(540deg, 50%, 50%)', 'hsl(180, 49.8, 50)'],
      /* Gradians */
      ['hsl(0grad, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      ['hsl(200grad, 50%, 50%)', 'hsl(180, 49.8, 50)'],
      ['hsl(400grad, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      /* Radians */
      ['hsl(0rad, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      ['hsl(3.14rad, 50%, 50%)', 'hsl(180, 49.8, 50)'],
      /* Turns */
      ['hsl(0turn, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      ['hsl(0.5turn, 50%, 50%)', 'hsl(180, 49.8, 50)'],
      ['hsl(1turn, 50%, 50%)', 'hsl(0, 49.8, 50)'],
      /* Scientific notation */
