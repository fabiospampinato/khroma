...
describe ( 'Color', it => {
  ...
  it ( 'supports HSL', t => {
    ...
    const tests = [
      ...
      ['hsl(180, 50, 50)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(180, 40.4, 70.4)', 'hsl(180, 40.3973509934, 70.3921568627)'],
      ...
      /* Degrees */
      ['hsl(-180deg, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(0deg, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      ['hsl(180deg, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(360deg, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      ['hsl(540deg, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      /* Gradians */
      ['hsl(0grad, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      ['hsl(200grad, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(400grad, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      /* Radians */
      ['hsl(0rad, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      ['hsl(3.14rad, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      /* Turns */
      ['hsl(0turn, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      ['hsl(0.5turn, 50%, 50%)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(1turn, 50%, 50%)', 'hsl(0, 49.8039215686, 50)'],
      /* Scientific notation */
      ['hsl(1.8e2, 4.04e1, .704e2)', 'hsl(180, 40.3973509934, 70.3921568627)'],
      ['hsl(1.8e2deg, 4.04e1%, .704e2%)', 'hsl(180, 40.3973509934, 70.3921568627)'],
      ['hsl(1800e-1deg, 404e-1%, 7040e-2%)', 'hsl(180, 40.3973509934, 70.3921568627)'],
      /* Mixed units */
      ['hsl(180, 50, 50%)', 'hsl(180, 49.8039215686, 50)'],
      ['hsl(180deg, 50, 50)', 'hsl(180, 49.8039215686, 50)'],
      /* With commas and weird spaces */
